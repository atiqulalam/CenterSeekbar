...
public class CenterPointSeekBar extends View {
    ...
    public CenterPointSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (thumbImageDrawable == null) {
            thumbImageDrawable = getResources().getDrawable(R.drawable.dragger);
        }
        ...
        if (thumbImagePressedDrawable == null) {
            thumbImagePressedDrawable = getResources().getDrawable(R.drawable.dragger);
        }
        ...
        lineHeight = 0.9f * thumbHalfHeight;
